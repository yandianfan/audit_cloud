...
public class WB395A102020BLH  extends BaseBLH{
	public BaseResponseEvent queryData(BaseRequestEvent req) throws Exception{
		...
		HashMap A102010 =(HashMap)BaseDAO.getInstance().findForObject("QysdsndMapper.formQuerryA102020", pageData);
	...
	public BaseResponseEvent update(BaseRequestEvent req) throws Exception{
		...
		BaseDAO.getInstance().update("GxqysdsMapper.updateA102020", A102020form);
        res.addMessage("保存成功");
		return res;
	}
