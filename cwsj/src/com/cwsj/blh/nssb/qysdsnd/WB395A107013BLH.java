...
public class WB395A107013BLH extends BaseBLH{
	public BaseResponseEvent queryData(BaseRequestEvent req) throws Exception{
		...
		HashMap A107013 =(HashMap) BaseDAO.getInstance().findForObject("QysdsndMapper.formQuerryA107013", pageData);
	...
	public BaseResponseEvent update(BaseRequestEvent req) throws Exception{
		...
		BaseDAO.getInstance().update("GxqysdsMapper.updateA107013", A107013form);   //修改form编号（2处）
        res.addMessage("保存成功");
		return res;
	}		
}
