...
public class WB395A108030BLH extends BaseBLH{
	public BaseResponseEvent queryData(BaseRequestEvent req) throws Exception{
		...
		List<Map> listA108030=(List<Map>) BaseDAO.getInstance().findForList("AqysdsMapper.listQuerryA108030", pzxh);
	...
	public BaseResponseEvent update(BaseRequestEvent req) throws Exception{
		...
		BaseDAO.getInstance().delete("GxqysdsGridMapper.deleteA108030", PZXH);
		BaseDAO.getInstance().batchSave("GxqysdsGridMapper.insertA108030", PlatformUtil.addGridcolvalue(listA108030,"PZXH",PZXH));		
        res.addMessage("保存成功");
		return res;
	}	
}
