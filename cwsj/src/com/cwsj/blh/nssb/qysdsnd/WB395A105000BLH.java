...
public class WB395A105000BLH extends BaseBLH{
	public BaseResponseEvent queryData(BaseRequestEvent req) throws Exception{
		...
		HashMap A105000 =(HashMap)BaseDAO.getInstance().findForObject("QysdsndMapper.formQuerryA105000", pageData);
	...
	public BaseResponseEvent update(BaseRequestEvent req) throws Exception{
		...
		BaseDAO.getInstance().update("GxqysdsMapper.updateA105000", A105000form);   //修改form编号（2处）
        res.addMessage("保存成功");
		return res;
	}	
