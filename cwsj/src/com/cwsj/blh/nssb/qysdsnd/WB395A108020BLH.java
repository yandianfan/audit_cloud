...
public class WB395A108020BLH extends BaseBLH{
	public BaseResponseEvent queryData(BaseRequestEvent req) throws Exception{
		...
		List<Map> listA108020=(List<Map>) BaseDAO.getInstance().findForList("AqysdsMapper.listQuerryA108020", pzxh);
	...
	public BaseResponseEvent update(BaseRequestEvent req) throws Exception{
		...
		BaseDAO.getInstance().delete("GxqysdsGridMapper.deleteA108020", PZXH);
		BaseDAO.getInstance().batchSave("GxqysdsGridMapper.insertA108020", PlatformUtil.addGridcolvalue(listA108020,"PZXH",PZXH));		
        res.addMessage("保存成功");
		return res;
	}		
}
