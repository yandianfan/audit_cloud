...
public class Tsdg050503 extends BaseBLH{
	public BaseResponseEvent init(BaseRequestEvent req) throws Exception{
		...
		Map formmap050503 =(Map) persistenceDAO.findForObject("GzdgzhlMapper.QuerryTsdg050503", qumap);
		res.addForm("Tsdg_050503form", formmap050503);

			
		res.addPage("dggl/tsdg/Tsdg_050503");
		return res;
	}
	...
	public BaseResponseEvent save(BaseRequestEvent req) throws Exception{
		...
		persistenceDAO.delete("GzdgzhlMapper.deleteTsdg050503", formmap);
		
		Map mapobj=req.getForm("Tsdg_050503form");
		formmap.putAll(mapobj);
		persistenceDAO.save("GzdgzhlMapper.insertTsdg050503",formmap);
