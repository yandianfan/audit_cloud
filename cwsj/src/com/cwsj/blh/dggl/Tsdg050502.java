...
public class Tsdg050502 extends BaseBLH{
	public BaseResponseEvent init(BaseRequestEvent req) throws Exception{
		...
		Map formmap050502 =(Map) persistenceDAO.findForObject("GzdgzhlMapper.QuerryTsdg050502", qumap);
		res.addForm("Tsdg_050502form", formmap050502);

		List<Map> SFselect =(List<Map>)persistenceDAO.findForList("GzdgzhlMapper.selectQuerrySF", null);
	...
	public BaseResponseEvent save(BaseRequestEvent req) throws Exception{
		...
		persistenceDAO.delete("GzdgzhlMapper.deleteTsdg050502", formmap);
		
		Map mapobj=req.getForm("Tsdg_050502form");
		formmap.putAll(mapobj);
		persistenceDAO.save("GzdgzhlMapper.insertTsdg050502",formmap);
