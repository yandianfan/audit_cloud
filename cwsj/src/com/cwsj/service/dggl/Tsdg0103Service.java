...
@Service("tsdg0103Service")
public class Tsdg0103Service{
	...
	public BaseResponseEvent init(BaseRequestEvent req) throws Exception{
		...
		Map formmap0103_1 =(Map) dao.findForObject("GzdgzhlMapper.QuerryTsdg0103_1", qumap);
		res.addForm("Tsdg_0103_1form", formmap0103_1);
		
		Map formmap0103_2 =(Map) dao.findForObject("GzdgzhlMapper.QuerryTsdg0103_1", qumap);
		res.addForm("Tsdg_0103_2form", formmap0103_2);		
		
		List<Map> gridlist1 =(List<Map>) dao.findForList("GzdgzhlMapper.QuerryTsdg0103_2", qumap);		 
		res.addGrid("gridlist_1", gridlist1);
		
		List<Map> gridlist2 =(List<Map>) dao.findForList("GzdgzhlMapper.QuerryTsdg0103_3", qumap);		 
		res.addGrid("gridlist_2", gridlist2);
		
		List<Map> gridlist3 =(List<Map>) dao.findForList("GzdgzhlMapper.QuerryTsdg0103_4", qumap);		 
	...
	public BaseResponseEvent save(BaseRequestEvent req) throws Exception{
		...
		//保存表单1
		dao.delete("GzdgzhlMapper.deleteTsdg0103_1", formmap);
		...
		dao.save("GzdgzhlMapper.insertTsdg0103_1",formmap);
		...
		dao.delete("GzdgzhlMapper.deleteTsdg0103_2", formmap2);
		dao.batchSave("GzdgzhlMapper.insertTsdg0103_2",gridlist1);	
		...
		dao.delete("GzdgzhlMapper.deleteTsdg0103_3", formmap2);
		dao.batchSave("GzdgzhlMapper.insertTsdg0103_3",gridlist2);	
		...
		dao.delete("GzdgzhlMapper.deleteTsdg0103_4", formmap2);
		dao.batchSave("GzdgzhlMapper.insertTsdg0103_4",gridlist3);			
