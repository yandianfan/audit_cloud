...
@Service("tsdg050503Service")
public class Tsdg050503Service extends BaseBLH{
	...
	public BaseResponseEvent init(BaseRequestEvent req) throws Exception{
		...
		Map formmap050503 =(Map) dao.findForObject("GzdgzhlMapper.QuerryTsdg050503", qumap);
	...
	public BaseResponseEvent save(BaseRequestEvent req) throws Exception{
		...
		dao.delete("GzdgzhlMapper.deleteTsdg050503", formmap);
		
		Map mapobj=req.getForm("Tsdg_050503form");
		formmap.putAll(mapobj);
		dao.save("GzdgzhlMapper.insertTsdg050503",formmap);
