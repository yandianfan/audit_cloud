...
@Service("tsdg0104Service")
public class Tsdg0104Service{
	...
	public BaseResponseEvent init(BaseRequestEvent req) throws Exception{
		...
		Map formmap0104 =(Map) dao.findForObject("GzdgzhlMapper.QuerryTsdg0104", qumap);
	...
	public BaseResponseEvent save(BaseRequestEvent req) throws Exception{
		...
		dao.delete("GzdgzhlMapper.deleteTsdg0104", formmap);
		
		Map mapobj=req.getForm("Tsdg_0104form");
		formmap.putAll(mapobj);
		dao.save("GzdgzhlMapper.insertTsdg0104",formmap);
