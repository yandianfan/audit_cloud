...
@Service("wb395A107014Service")
public class Wb395A107014Service{
	...
	public BaseResponseEvent queryData(BaseRequestEvent req) throws Exception{
		...
		List<Map> listA107014 =(List<Map>) dao.findForList("AqysdsMapper.listQuerryA107014", pzxh);
	...
	public BaseResponseEvent update(BaseRequestEvent req) throws Exception{
		...
		dao.delete("GxqysdsGridMapper.deleteA107014", PZXH);
		dao.batchSave("GxqysdsGridMapper.insertA107014", PlatformUtil.addGridcolvalue(listA107014,"PZXH",PZXH));	
        res.addMessage("保存成功");
		return res;
	}		
}
