...
@Service("wb395A105010Service")
public class Wb395A105010Service{
	...
	public BaseResponseEvent queryData(BaseRequestEvent req) throws Exception{
		...
		HashMap A105010 =(HashMap) dao.findForObject("QysdsndMapper.formQuerryA105010", pageData);
	...
	public BaseResponseEvent update(BaseRequestEvent req) throws Exception{
		...
		dao.update("GxqysdsMapper.updateA105010", A105010form);   //修改form编号（2处）
        res.addMessage("保存成功");
		return res;
	}		
}
