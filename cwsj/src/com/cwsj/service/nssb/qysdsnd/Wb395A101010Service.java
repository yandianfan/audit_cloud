...
@Service("wb395A101010Service")
public class Wb395A101010Service{
	...
	public BaseResponseEvent queryData(BaseRequestEvent req) throws Exception{
		...
		HashMap A101010 =(HashMap)dao.findForObject("QysdsndMapper.formQuerryA101010", pageData);
	...
	public BaseResponseEvent update(BaseRequestEvent req) throws Exception{
		...
		dao.update("GxqysdsMapper.updateA101010", A101010form);
        res.addMessage("保存成功");
		return res;
	}
}
