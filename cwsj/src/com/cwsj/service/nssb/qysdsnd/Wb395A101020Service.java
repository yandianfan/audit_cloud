...
@Service("wb395A101020Service")
public class Wb395A101020Service{
	...
	public BaseResponseEvent queryData(BaseRequestEvent req) throws Exception{
		...
		HashMap A101020 =(HashMap) dao.findForObject("QysdsndMapper.formQuerryA101020", pageData);
	...
	public BaseResponseEvent update(BaseRequestEvent req) throws Exception{
		...
		dao.update("GxqysdsMapper.updateA101020", A101020form);
        res.addMessage("保存成功");
		return res;
	}
}
