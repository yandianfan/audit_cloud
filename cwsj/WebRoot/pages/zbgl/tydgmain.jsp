...
<div id="page-content" >
			    ...
			    <h3>数据维护 <small><i class="icon-double-angle-right"></i> 通用底稿定义</small>
  ...
  <div class="row-fluid">
			...
			<div class="widget-body">			 
			 <div class="widget-main">
				...
				<table style="width:99%;" id="xtable">
					<tr>
						<td>
							 <input type="text" id="dgmc" class="form-control"  value="${dgnr.DG_MC}" placeholder="请输入底稿名称" style="width:90%"/>
						</td>
						<td>
							 <input type="text" id="dgdm" class="form-control"  value="${dgnr.DG_DM}" placeholder="请输入底稿编码" style="width:90%"/>
						</td>
						<td>底稿类型
						</td>
						<td>
								<select id="dglxselect"  class="form-control" title="底稿类型" value="${dgnr.DGLX_DM}" style="width:90%">
								</select>
								<input type="text" id="dglx"  value="${dgnr.DGLX_DM}" style="display:none"/>
						</td>						
					</tr>
					<tr>
							...
							<form class="form-horizontal" role="form" id="jcsxform" enctype='multipart/form-data'>
									<fieldset>
										...
										<div class="form-group">
											<label for="ds_host" class="col-sm-2 control-label">模板上传</label>
											<div class="col-sm-4">
                                               <input type="file" style="display:inline-block;width:99%" class="form-control"  id="file"/>   
											</div>	
											<label for="ds_host" class="col-sm-2 control-label">已上传模板</label>
											<div  class="col-sm-4">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="pages/zbgl/tydgmain.js"></script>		
	</body>
</html>
