		          ...
		          <h3>数据审核 <small><i class="icon-double-angle-right"></i> 审计初审</small>
		           <ul class="nav ace-nav pull-right">
		            <div class="btn-group btn-group-small">
		                  <button type="button" class="btn btn-small btn-primary" onclick="onSubmit()">提交</button>
						...
						<div class="tab-content">
						     ...
						     <div class="row-fluid">
                                <div class="span6">
                                 <div class="tabbable">
									  ...
									  <a class='btn btn-mini btn-info' title="生成工作底稿" onclick="onRefreshgzdg()" >生成工作底稿</a>
									</ul> 
									<div class="tab-content">
							...
							<c:forEach items="${sbblist}" var="sbb" varStatus="vs">
								<tr>
									...
									<td>${sbb.SSQ}</td>
									<td><a class='btn btn-mini btn-info' title="生成申报表数据" onclick="onRefreshsbb('${sbb.PZ_XH}')" >生成申报表数据</a></td>
								</tr> 
							</c:forEach>  
							</table>                            
							</div>
