...
<body>
       ...
       <input type="text" style="display:none" value="${LCSLH}" id="LCSLH"/>
		<div id="page-content" class="clearfix">
			<div class="page-header position-relative">
		          <h3>数据审核 <small><i class="icon-double-angle-right"></i> 审计初审</small>
		           <ul class="nav ace-nav pull-right" style="height: 5px; ">
		            <div class="btn-group btn-group-small">
		                  <button type="button" class="btn btn-small btn-primary" onclick="sjcyonSubmit()">提交</button>
		                  <button type="button" class="btn btn-small btn-primary" onclick="ckYssj()">查看原始账套</button>
		            </div>           
		           </ul>
		          </h3>			     
			</div>			
									...
									<fieldset>
										<div class="form-group">
											...
											<div class="col-sm-4">
												...
												<input type="text" style="display:none" readonly class="form-control" value="${BJBJ}" id="BJBJ"/>
												<input type="text" style="display:none" readonly class="form-control" value="${SSSQ}" id="SSSQ"/>												
											</div>
										</div>
									</fieldset>
						     ...
						     <div class="row-fluid">
                                <div class="span6">
                                 <div class="tabbable">
									  ...
									  <li><a data-toggle="tab" href="#TYDG"><i class="blue icon-user bigger-110"></i> 通用底稿</a></li>		  
									</ul> 
									<div class="tab-content">
									  ...
									  <div id="TYDG" class="tab-pane">
								            <div id="listtydg" class="DataGrid" type="DataGrid" css="table table-striped table-bordered table-hover" caption="显示信息">
								              <div name="Index" style="width:5%" caption="序号"></div>
								              <div name="DG_DM" style="display:none"  caption="底稿代码" style="display:none"></div>
								              <div name="DG_MC" caption="底稿名称" type="a" onclick="modifyTydg()"></div>
								              <div name="DGLX_MC" style="display:none" caption="底稿类型"></div>
								            </div>										       
									  </div>										  									  									  
									</div>                              
    ...
    <script type="text/javascript" src="public/js/workflow.js"></script>
