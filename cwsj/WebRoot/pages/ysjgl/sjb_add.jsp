...
<body>
	<form  action="dictionaries/save.do" name="Form" id="Form" method="post" >
		...
		<table>
			<tr class="info">
				<td><input type="text" name="NAME" id="NAME" placeholder="这里输入名称" value="" title="名称"/></td>
			</tr>
			<tr class="info">
				<td><input type="text" name="BIANMA" id="BIANMA" placeholder="" value="pd33" title="编码"/></td>
			</tr>
			<tr class="info">
				<td><input type="number" name="ORDY_BY" id="ORDY_BY" placeholder="" value="xxx" title="说明"/></td>
			</tr>
			<tr>
