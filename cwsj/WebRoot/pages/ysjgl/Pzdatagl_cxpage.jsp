...
<body>
	<div class="container-fluid">
		<div id="page-content"  class="clearfix">	
			<div class="page-header position-relative">
			    <h3>源数据管理 <small><i class="icon-double-angle-right"></i>凭证数据查询</small>
	...
	<script type="text/javascript">
		...
		function modify(rowData){
		  siMenu("103_1","103","凭证查询","pzdataglCtrl/cxpageinit?LSH="+rowData.getValue("LSH")+"&CWBBDL_DM="+rowData.getValue("CWBBDL_DM")+"&DJXH="+rowData.getValue("DJXH"));
		}
	</script>	
</body>
</html>