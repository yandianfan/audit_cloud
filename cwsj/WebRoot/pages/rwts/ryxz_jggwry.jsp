...
<div class="container-fluid" id="main-container">	
		<div id="page-content">
			...
			<input style="display:none" id="retrydm" />	
			<input style="display:none" id="retrymc" />
			<input style="display:none" id="retzzjgdm" />
			 <div class="row-fluid">
...
<!-- PAGE CONTENT ENDS HERE -->
       ...
       function queding(){
          if($("#ryselect").find("option:selected").val()==undefined){
             ...
             var retrydm=$("#ryselect").find("option:selected").val();
             var retrymc=$("#ryselect").find("option:selected").text();
             var retzzjgdm=$("#zzjgselect").find("option:selected").val();
             $("#retrydm").val(retrydm);
             $("#retrymc").val(retrymc);
             $("#retzzjgdm").val(retzzjgdm);
             winclose();
          }
