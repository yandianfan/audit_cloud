...
<body>
       ...
       <div class="row-fluid">
         <div class="span">
	           <div id="listA107020" type="DataGrid" class="DataGrid" css="table table-striped table-bordered table-hover" userdefine="true">               
					...
					<div name="XMSR" type="text" css="width:99%"></div>
					<div name="XMCB" type="text" css="width:99%"></div>
					<div name="XGSF" type="text" css="width:99%"></div>
					<div name="YFTQJFY" type="text" css="width:99%"></div>
					<div name="NSTZE" type="text" css="width:99%"></div>
					<!-- <div name="XMSDE" type="text" css="width:99%"></div> -->
					<div name="XMSDE_MSSR" type="text" css="width:99%"></div>
					<div name="XMSDE_JBSR" type="text" css="width:99%"></div>
					<div name="JMSDE" type="text" css="width:99%"></div>
                </div>
         </div> 		   	       
       </div> 
    ...
    function saveGlgx(){
          ...
          $w1.pushGrid("listA107020");
          $w1.ajax("/wb395A107020Ctrl/update");    
     }
