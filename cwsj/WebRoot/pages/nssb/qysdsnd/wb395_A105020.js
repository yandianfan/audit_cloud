	...
	try {
		var tb = new Ext.Toolbar({
			...
			items : ['-', '->', '-', {
						...
						id : "tbsmBtn",
						handler : function() {
							openMaxWindow("/nssb/wb395/wb395_A105020_TbSm.html");
						...
						iconCls : "print",
						handler : function() {
							openMaxWindow("/WB395A105020Action.do?pzXh="
...
function tempSave() {
	...
	waitDialog();
//	new Ajax.Request('/WB395A105020Action.do', {
//				method : 'post',
//				parameters : $('WB395A105020Form').serialize(),
...
//			});
	...
	$.ajax({
		url : "/WB395A105020Action.do",
		async : true,
		dataType : "html",
		data : $('#WB395A105020Form').serialize(),
		type : 'post',
