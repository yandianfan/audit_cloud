			...
			try {
				var tb = new Ext.Toolbar({
							...
							items : ['-', '->', '-', {
									...
									id : "tbsmBtn",
									handler : function() {
										openMaxWindow("/nssb/wb395/wb395_A105040_TbSm.html");
									...
									scope : this
										...
										iconCls : "print",
										handler : function() {
											openMaxWindow("/WB395A105040Action.do?pzXh="
													+ $F("vo.pzxh")
...
function tempSave() {
	...
	waitDialog();
//	new Ajax.Request('/WB395A105040Action.do', {
//				method : 'post',
//				parameters : $('WB395A105040Form').serialize(),
...
//			});
	...
	$.ajax({
		url : "/WB395A105040Action.do",
		async : true,
		dataType : "html",
		data : $('#WB395A105040Form').serialize(),
		type : 'post',
