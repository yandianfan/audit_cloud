	...
	try {
		var tb = new Ext.Toolbar({
			...
			items : ['-', '->', {
				...
				iconCls : "fb",
				handler : function() {
					openMaxWindow("/nssb/wb395/wb395_A102010_TbSm.html");
				...
				handler : function() {
					...
					openMaxWindow("/WB395A102010Action.do?handleCode=printPage&pzXh="
							+ $F("pzXh"));
				},
				scope : this
			}, "-", {
...
function tempSave(button) {
	...
	waitDialog();
//	new Ajax.Request('/WB395A102010Action.do', {
//				method : 'post',
//				parameters : $('WB395A102010Form').serialize(),
...
//			});
	...
	$.ajax({
		url : "/WB395A102010Action.do",
		async : true,
		dataType : "html",
		data : $('#WB395A102010Form').serialize(),
		type : 'post',
