	...
	try {
		var tb = new Ext.Toolbar({
			...
			items : ['-', '->', {
						...
						iconCls : "fb",
						handler : function() {
							openMaxWindow("/nssb/wb395/wb395_A105120_TbSm.html");
						},
						scope : this
					}, {
						id : "tempBtn",
						...
						handler : function() {
							...
							openMaxWindow("/WB395A105120Action.do?handleCode=printPage&pzXh="
									+ $F("pzXh"));
						},
						scope : this
					}, "-", {
...
function tempSave() {
	...
	waitDialog();
//	new Ajax.Request('/WB395A105120Action.do', {
//				method : 'post',
//				parameters : $('WB395A105120Form').serialize(),
...
//			});
	...
	$.ajax({
		url : "/WB395A105120Action.do",
		async : true,
		dataType : "html",
		data : $('#WB395A105120Form').serialize(),
		type : 'post',
