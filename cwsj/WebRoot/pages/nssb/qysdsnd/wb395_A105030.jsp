...
<body>
		 ...
		 <div class="row page-header text-center">
            <strong class="sb-title3">投资收益纳税调整明细表</strong>
  				<div class="btn-menu noprint">
  				    <a class="btn btn-small btn-success" onclick="dgScsbb('A105030')">自动取数</a>
  				    <!-- 
	...
	<table id="listA105030Grid_table" width="98%" style="border-collapse: collapse" align="center"
		...
		<tr align="center">
	       ...
	       <div id="listA105030Grid" type="DataGrid" class="DataGrid" userdefine="true">       
	          ...
	          <div name="CYSY_ZZJE" type="text" css="height: 34px;"  caption="持有收益-账载金额"></div>
	          <div name="CYSY_SSJE" type="text"css="height: 34px;"  caption="持有收益-税收金额"></div>
	          <div name="CYSY_NSTZJE" type="text"css="height: 34px;"  caption="持有收益-纳税调整金额"></div>
	          <div name="CZSY_KJQRCZSR" type="text"css="height: 34px;"  caption="处置收益-会计确认的处置收入 "></div>	          
	          <div name="CZSY_SSJSCZSR" type="text"css="height: 34px;"  caption="处置收益-税收计算的处置收入"></div>
	          <div name="CZSY_CZTZZMJZ" type="text"css="height: 34px;"  caption="处置收益-处置投资的账面价值 "></div>
	          <div name="CZSY_CZTZJSJC" type="text"css="height: 34px;"  caption="处置收益-处置投资的计税基础 "></div>
	          <div name="CZSY_KJQRCZSD" type="text"css="height: 34px;"  caption="处置收益-会计确认的处置所得或损失"></div>
	          <div name="CZSY_SSJSCZSD" type="text"css="height: 34px;"  caption="处置收益-税收计算的处置所得 "></div>
	          <div name="CZSY_NSTZJE" type="text"css="height: 34px;"  caption="处置收益 -纳税调整金额 "></div>
	          <div name="NSTZJEHJ" type="text"css="height: 34px;"  caption="纳税调整金额 "></div>
	       </div>	
	       <!-- 
    ...
    function saveGlgx(callback){
          ...
          $w1.pushGrid("listA105030Grid");
          $w1.ajax("/wb395A105030Ctrl/update",callback);    
     }
