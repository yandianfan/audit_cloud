...
<body>
  <div class="page-content">            
		 <div class="row page-header text-center">
            <strong class="sb-title3">符合条件的居民企业之间的股息、红利等权益性投资收益优惠明细表</strong>
  				<div class="btn-menu noprint">
  				    <a class="btn btn-small btn-success" onclick="dgScsbb('A107011')">自动取数</a>
       ...
       <div class="row-fluid">
         <div class="span">         
	       <div id="listA107011" type="DataGrid" class="DataGrid" css="table table-striped table-bordered table-hover" userdefine="true">
	          ...
	          <div name="BTZQYMC" type="text" css="text-align:left" caption="000000"></div>
	          <div name="TZXZ_DM" type="select" caption="000000"></div>
	          <div name="TZCB_JE" type="text" caption="000000"></div>
	          <div name="TZBL" type="text" caption="000000"></div>
	          <div name="LRFPRQ" type="date" caption="000000"></div>
	          <div name="LRFPSY_JE" type="text" caption="000000"></div>
	          <div name="QSSYZC_JE" type="text" caption="000000"></div>
	          <div name="QSWFPBF_JE" type="text" caption="000000"></div>
	          <div name="QSGXSD_JE" type="text" caption="000000"></div>
	          <div name="CHTZQDZC_JE" type="text" caption="000000"></div>
	          <div name="CHTZBL" type="text" caption="000000"></div>
	          <div name="CHCSCB_JE" type="text" caption="000000"></div>
	          <div name="QDCGCB_JE" type="text" caption="000000"></div>
	          <div name="CHWFP_JE" type="text" caption="000000"></div>
	          <div name="CHGXSD_JE" type="text" caption="000000"></div>
	          <div name="HJ_JE" type="text" caption="000000"></div>
	       </div>
	<!-- 
       	   <div class="btn-group btn-group-xs">
				<button type="button" class="btn  btn-primary" onclick="addGridRow('listA107011')">新增</button>			    
				<button type="button" class="btn  btn-primary " onclick="deleteGridRow('listA107011');">删除</button>
		   </div>	
	 -->       
    ...
    function saveGlgx(){
          ...
          $w1.pushGrid("listA107011");
          $w1.ajax("/wb395A107011Ctrl/update");    
     }
