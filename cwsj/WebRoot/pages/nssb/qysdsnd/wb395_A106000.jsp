		 ...
		 <div class="row page-header text-center">
            <strong class="sb-title3">企业所得税弥补亏损明细表</strong>
  				<div class="btn-menu noprint">
  				    <a class="btn btn-small btn-success" onclick="dgScsbb('A106000')">自动取数</a>
			...
			<table width="2160" style="border-collapse: collapse" align="center" id="listA106000_table" cellpadding="1" cellspacing="1" border="1" bordercolor="#000000">
             <thead>				
				<tr align="center">
       ...
       <div class="row-fluid">
         <div class="span">        
	       <div id="listA106000" type="DataGrid" class="DataGrid" css="table table-striped table-bordered table-hover" userdefine="true">
	          ...
	          <div name="ND" type="text" css="width:99%"></div>
	          <div name="NSTZHSD_JE" type="text" css="width:99%"></div>
	          <div name="HBFLZRKS_JE" type="text" css="width:99%"></div>
	          <div name="DNKNBKS_JE" type="text" css="width:99%"></div>
	          <div name="YQNDKSNB4_JE" type="text" css="width:99%"></div>
	          <div name="YQNDKSNB3_JE" type="text" css="width:99%"></div>
	          <div name="YQNDKSNB2_JE" type="text" css="width:99%"></div>
	          <div name="YQNDKSNB1_JE" type="text" css="width:99%"></div>
	          <div name="YQNDKSNBHJ_JE" type="text" css="width:99%"></div>
	          <div name="SJNBYQNDKS_JE" type="text" css="width:99%"></div>
	          <div name="JZYHNDNBKS_JE" type="text" css="width:99%"></div>
	       </div>
         </div>		   	       
       </div>   				
