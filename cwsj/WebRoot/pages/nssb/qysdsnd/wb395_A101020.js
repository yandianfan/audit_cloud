	...
	try {
		var tb = new Ext.Toolbar({
			...
			items : ['-', '->', '-', {
						...
						id : "tbsmBtn",
						handler : function() {
							openMaxWindow("/nssb/wb395/wb395_A101020_TbSm.html");
						...
						iconCls : "print",
						handler : function() {
							openMaxWindow("/WB395A101020Action.do?pzXh="
									+ $F("a101020VO.pzxh")
...
function tempSave() {
	...
	waitDialog();
//	new Ajax.Request('/WB395A101020Action.do', {
//				method : 'post',
//				parameters : $('WB395A101020Form').serialize(),
...
//			});
	...
	$.ajax({
		url : "/WB395A101020Action.do",
		async : true,
		dataType : "html",
		data : $('#WB395A101020Form').serialize(),
		type : 'post',
