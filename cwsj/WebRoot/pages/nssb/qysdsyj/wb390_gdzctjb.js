		...
		var tb = new Ext.Toolbar({
			...
			items : ['-', '->', {
						...
						handler : function() {
							...
							openMaxWindow("/WB390gdzctjbAction.do?handleCode=printPage&pzxh="
									+ $F('pzxh'));
						},
						scope : this
					}, '-', {
...
function initPage() {
	...
	// $ES("hjbqjszjje")[0].value = "";
	// $ES("hjljzczjje")[0].value = "";
	// $ES("hjljjszjje")[0].value = "";
	// }
	// }
	// initCalTable(a, true);
	// runRulesForID(a);
			...
			if (i < $ES("xmmc").length) {
				...
				if (i == 1) {
					...
					if ("07" == $ES('hybj')[i].value) {
						$('div_fjyje1').style.display = "";
						$('div_fjbqje1').style.display = "";
						$('div_fjljje1').style.display = "";
						$('div_fjyje3').style.display = "";
						$('div_fjbqje3').style.display = "";
						$('div_fjljje3').style.display = "";
						$('div_fjyje5').style.display = "";
						$('div_fjbqje5').style.display = "";
						$('div_fjljje5').style.display = "";
						$('div_fjyje2').style.display = "none";
						$('div_fjbqje2').style.display = "none";
						$('div_fjljje2').style.display = "none";
						$('div_fjyje4').style.display = "none";
						$('div_fjbqje4').style.display = "none";
						$('div_fjljje4').style.display = "none";
						$('div_fjyje6').style.display = "none";
						$('div_fjbqje6').style.display = "none";
						$('div_fjljje6').style.display = "none";
						...
						$('div_fjyje1').style.display = "none";
						$('div_fjbqje1').style.display = "none";
						$('div_fjljje1').style.display = "none";
						$('div_fjyje3').style.display = "none";
						$('div_fjbqje3').style.display = "none";
						$('div_fjljje3').style.display = "none";
						$('div_fjyje5').style.display = "none";
						$('div_fjbqje5').style.display = "none";
						$('div_fjljje5').style.display = "none";
						$('div_fjyje2').style.display = "";
						$('div_fjbqje2').style.display = "";
						$('div_fjljje2').style.display = "";
						$('div_fjyje4').style.display = "";
						$('div_fjbqje4').style.display = "";
						$('div_fjljje4').style.display = "";
						$('div_fjyje6').style.display = "";
						$('div_fjbqje6').style.display = "";
						$('div_fjljje6').style.display = "";
					}
				}
				if ("" != rowInfo.sytj) {
					$(("tmp_sytj_" + i)).value = rowInfo.sytj;
					if ("01" == rowInfo.sytj) {
...
function tempSave(button) {
	...
	$('sucessMsg').value = '';
	$("handleDesc").value = "";
	$("handleCode").value = "tempSave";
	waitDialog();
	new Ajax.Request('/WB390gdzctjbAction.do', {
				method : 'post',
				parameters : $('WB390gdzctjbForm').serialize(),
