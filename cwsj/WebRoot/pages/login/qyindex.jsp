...
<body>
	...
	<!-- 页面顶部¨ -->
	<%@ include file="qyhead.jsp"%>

	<div class="container-fluid" id="main-container">
		<!-- menu toggler -->

		<!-- 左侧菜单 -->
		<%@ include file="qyleft.jsp"%>
		...
		<div id="main-content" class="clearfix">
			...
			<div>
				<iframe name="mainFrame" id="mainFrame" frameborder="0" src="tabs.do" style="margin:0 auto;width:100%;height:100%;"></iframe>
			</div>
	...
	<!-- basic scripts -->
		...
		<!--引入属于此页面的js -->
		<script type="text/javascript" src="pages/login/index.js"></script>
</body>
</html>
