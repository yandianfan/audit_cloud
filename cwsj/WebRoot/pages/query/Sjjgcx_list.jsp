...
<body>
	<div class="container-fluid">
		<div id="page-content"  class="clearfix">	
			...
			<div class="row-fluid">
				<div id="listCursqxx" class="DataGrid" type="DataGrid" css="table table-striped table-bordered table-hover" caption="我的审计风险信息">
	...
	<script type="text/javascript">
       $(top.hangge());
		...
		function modify(rowData){
		  ...
		  siMenu(rowData.getValue("LSH"),'lm1','风险信息',"sjjgcxCtrl/initQysjsj?LSH="+rowData.getValue("LSH")+"&DJXH="+rowData.getValue("DJXH")+"&SSSQ="+rowData.getValue("SSSQ"));
		}
	</script>	
</body>
</html>