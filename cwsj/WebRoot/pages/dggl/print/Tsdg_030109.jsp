...
<head>
  ...
  <body>
   	<div class="page-content">
		<div class="col-xs-12">
         ...
         <table id="gridlist_table" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="960">

 <tr height="33">
  <td colspan="8" height="16" align="right">索引号：3-1-9</td>
 </tr>
 <tr height="33">
  <td colspan="7" height="16">被审核单位名称：${QYMC}</td>
  <td>金额单位：元</td>
 </tr>
 <tr height="33">
 ...
 <tr height="33" style='height:12.0pt'>
