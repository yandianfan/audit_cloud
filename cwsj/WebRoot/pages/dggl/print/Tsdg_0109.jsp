...
<select id="COL7"  class="form-control">
 ...
 <tr height=16 style='height:12.0pt'>
  <td colspan=2 height=16 class=xl9711419 style='height:12.0pt;border-left:none'><div id="COL53"></div></td>
  <td class=xl8811419 style='border-top:none;border-left:none'><input type="date" class="form-control" id="COL54"></td>
  
  
 </tr>
 <tr height=16 style='height:12.0pt'>
  <td colspan=2 height=16 class=xl9711419 style='height:12.0pt;border-left:none'><div id="COL55"></div></td>
 ...
 <tr height=16 style='height:12.0pt'>
  <td colspan=2 height=16 class=xl9711419 style='height:12.0pt;border-left:none'><div id="COL58"></div></td>
  <td class=xl8811419 style='border-top:none;border-left:none'><input type="date" class="form-control" id="COL59"></td>
  
  
 </tr>
 <tr height=16 style='height:12.0pt'>
  <td colspan=2 height=16 class=xl9711419 style='height:12.0pt;border-left:none'><div id="COL60"></div></td>
