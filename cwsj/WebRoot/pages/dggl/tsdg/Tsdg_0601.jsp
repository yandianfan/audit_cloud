   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">境外所得税抵免审核表</strong>
         ...
         <table id="gridlist_table" width="3520" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="21" height="33"  align="right">索引号：6-1</td>
            </tr>
            <tr height="33">
            ...
            <tr height="25">
                ...
                <td rowspan="2" width="160">弥补境外以前年度亏损</td>
                <td rowspan="2" width="160">境外应纳税所得额</td>
                <td rowspan="2" width="160">抵减境内亏损</td>
                <td rowspan="2" width="160">抵减境内亏损后的境外应纳税所得额</td>
                <td rowspan="2" width="160">税率</td>
                <td rowspan="2" width="160">境外所得应纳税额</td>
                <td rowspan="2" width="160">境外所得可抵免税额</td>
                <td rowspan="2" width="160">境外所得抵免限额</td>
                <td rowspan="2" width="160">本年可抵免境外所得税额</td>
                <td rowspan="2" width="160">未超过境外所得税抵免限额的余额</td>
                <td rowspan="2" width="160">本年可抵免以前年度未抵免境外所得税额</td>
                <td colspan="4" width="640">按简易办法计算</td>
                <td rowspan="2" width="160">境外所得抵免所得税额合计</td>
                <td rowspan="2" width="160">备注</td>
            </tr>
            <tr height="25">
                <td width="160">按低于12.5%的实际税率计算的抵免额</td>
                <td width="160">按12.5%计算的抵免额</td>
                <td width="160">按25%计算的抵免额</td>
                <td width="160">小计</td>
            </tr>
            <tr height="25">
                <td width="160">1</td>
       ...
       <div class="row-fluid">
         <div class="span">          
  			...
  			<form class="form-horizontal" role="form" id="formmap">
				<table align="center" style="border-collapse: collapse" ; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="3528">
