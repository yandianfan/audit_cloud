   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">无形资产摊销审核表</strong>
         ...
         <table id="gridlist_table" width="2000" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="19" height="33"  align="right">索引号：3-3-3</td>
            </tr>
            <tr height="33">
            ...
            <tr height="25">
                ...
                <td rowspan="3" width="160">无形资产类别</td>
                <td colspan="6" width="960">审核数</td>
            ...
            <tr height="25">
                ...
                <div id="gridlist" class="DataGrid" type="DataGrid" userdefine="true">
					...
					<div name="COL8" type="date" css="width:99%"></div>
