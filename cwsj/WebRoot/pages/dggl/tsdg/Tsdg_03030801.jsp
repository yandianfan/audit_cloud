...
<head>
	...
	<title>资产损失（专项申报）税前扣除及纳税调整审核表</title>
  </head>
   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">资产损失（专项申报）税前扣除及纳税调整审核表</strong>
         ...
         <table id="gridlist_table" width="100%" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="10" height="33"  align="right">索引号：3-3-8-1</td>
            </tr>
            <tr height="33">
                <td colspan="9" width="1080">被审核单位名称：${QYMC}</td>
                <td width="160">金额单位：元</td>
            </tr>
 
            <tr height="33">
                <td rowspan="2" colspan="3" width="360">会计期间或会计截止日：</td>
                <td rowspan="2" colspan="3" width="360">${KJQJ}　</td>
                <td width="160">编制人</td>
                <td width="160">${BZR}　</td>
                <td width="160">日期</td>
            ...
            <tr height="25">
                ...
                <td width="160">账载金额</td>
                <td width="160">处置收入</td>
                <td width="160">赔偿收入</td>
                <td width="160">计税基础</td>
                <td width="160">税收金额</td>
                <td width="160">纳税调整金额</td>
                <td width="160">备注</td>
            </tr>           
            ...
            <tr height="25">
                ...
                <td width="160">4</td>
                <td width="160">5</td>
                <td width="160">6（5-3-4）</td>
                <td width="160">7（2-6）</td>
                <td width="160">8</td>
            </tr> 
         </table>         
                ...
                <div id="gridlist" class="DataGrid" type="DataGrid" userdefine="true">
					...
					<div name="DGHC" caption="行次" type="text" style="display:none"></div>
					<div name="DGHMC"  type="select" caption="项目" datasrc="1|一、货币资产损失,2|二、非货币资产损失,3|三、投资损失,4|四、其他,11|小计(货币资产损失),21|小计(非货币资产损失),31|小计(投资损失),41|小计(其他),5|合计"></div>
