 ...
 <tr height=16 style='height:12.0pt'>
  ...
  <td width=109>13</td>
				...
				<div id="gridlist" class="DataGrid" type="DataGrid" userdefine="true">
					...
					<div name="COL1" type="text" css="width:99%" caption="具体内容"></div>
					<div name="COL2" type="date" css="width:80px" caption="起始日期"></div>
					<div name="COL3" type="text" css="width:99%" caption="合同金额（交易金额"></div>
					<div name="COL4" type="text" css="width:99%" caption="账载金额"></div>
					<div name="COL5" type="text" css="width:99%" caption="00000000"></div>
					<div name="COL6" type="text" css="width:99%" caption="00000000"></div>
					<div name="COL7" type="text" css="width:99%" caption="00000000"></div>
					<div name="COL8" type="text" css="width:99%" caption="00000000"></div>
					<div name="COL9" type="text" css="width:99%" caption="00000000"></div>
					<div name="COL10" type="text" css="width:99%" caption="00000000"></div>
					<div name="COL11" type="text" css="width:99%" caption="00000000"></div>
					<div name="COL12" type="text" css="width:99%" caption="00000000"></div>
					<div name="COL13" type="text" css="width:99%" caption="00000000"></div>
				</div>
