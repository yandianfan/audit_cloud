  ...
  <body>
   	<div class="page-content">
		<div class="col-xs-12">
         ...
         <table id="gridlist_table" width="2880" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">

            <tr height="33">
                <td colspan="18" align="right">索引号：3-4-4</td>
            </tr>
            <tr height="33">
                <td colspan="16" width="2560">被审核单位名称：${QYMC}</td>
                <td  width="160">金额单位：元</td>
            </tr>
            <tr height="33">
                <td colspan="4" rowspan="2" width="640">会计期间或会计截止日：</td>
                <td colspan="6" rowspan="2" width="960">${KJQJ}　</td>
                <td width="160">编制人</td>
                <td colspan="3" width="480">${BZR}　</td>
                <td width="160">日期</td>
                <td colspan="2" width="240">${BZRQ}　</td>
            </tr>
            <tr height="33">
                <td width="160">复核人</td>
                <td colspan="3" width="480">${FHR}　</td>
                <td width="160">日期</td>
                <td colspan="2" width="240">${FHRQ}　</td>
            </tr>
 
            <tr height="25">
                <td rowspan="3" width="40" align="center">请选择</td>
                <td rowspan="3" width="160" align="center" style="display:none">行次</td>
                <td rowspan="2" width="280" align="center">项目名称</td>
            ...
            <tr height="25">
                <td width="280" align="center">1</td>
       ...
       <div class="row-fluid">
         <div class="span">     
  			...
  			<form class="form-horizontal" role="form" id="formmap">
				<table align="center" style="border-collapse: collapse" ; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="2880">
