...
<head>
  ...
  <body>
   	<div class="page-content">
		<div class="col-xs-12">
         ...
         <table id="gridlist_table" width="1800" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
 ...
 <tr height="25">
  <td rowspan="3" width="80">请选择</td>
  <td rowspan="3" width="60" style="display:none">行次</td>
       ...
       <div class="row-fluid">
         <div class="span">           
                <div id="gridlist" class="DataGrid" type="DataGrid" userdefine="true">
					...
					<div name="DGHC" caption="行次" type="text" style="display:none" css="width:99%"></div>
  			...
  			<form class="form-horizontal" role="form" id="formmap">
				<table align="center" style="border-collapse: collapse" ; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="1800">
