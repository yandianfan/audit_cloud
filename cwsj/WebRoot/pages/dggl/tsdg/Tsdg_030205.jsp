   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">利息支出审核表</strong>
         ...
         <table id="gridlist_table" width="2240" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="14" height="33"  align="right">索引号：索引号：3-2-5</td>
            </tr>
            <tr height="33">
                <td colspan="12" width="1920">被审核单位名称：${QYMC}</td>
            ...
            <tr height="33">
                ...
                <td width="160">编制人</td>
                <td width="320" colspan="2">${BZR}　</td>
                <td width="160">日期</td>
                <td width="320" colspan="2">${BZRQ}　</td>
            </tr>
            <tr height="33">
                <td width="160">复核人</td>
                <td width="320" colspan="2">${FHR}　</td>
                <td width="160">日期</td>
                <td width="320" colspan="2">${FHRQ}　</td>
            </tr>

            <tr height="25">
                <td rowspan=2 width="160">行次</td>
                <td rowspan=2 width="160">利息分类</td>
                <td width="160">贷款单位</td>
                <td width="160">借款本金</td>
                <td width="160">借款期限</td>
                <td width="160">借款利率</td>
                <td width="160">其中：资本化利息</td>
                <td width="160">未审数</td>
                <td width="160">调整数</td>
                <td width="160">审核数</td>
                <td width="160">税收金额</td>
                <td width="160">调增金额</td>
                <td width="160">调减金额</td>
                <td width="160">备注</td>
            </tr>
            <tr height="25">
                <td width="160">1</td>
  			...
  			<form class="form-horizontal" role="form" id="formmap">
				<table align="center" style="border-collapse: collapse" ; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="2240">
