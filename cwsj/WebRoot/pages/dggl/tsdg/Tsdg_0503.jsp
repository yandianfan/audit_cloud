   	...
   	<div class="page-content">
		<div class="col-xs-12">
         ...
         <table id="gridlist_table" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="1200">
            ...
            <tr height="33">
                <td colspan="11" align="right">索引号：5-3</td>
            </tr>
            <tr height="33">
            ...
            <tr height="25" align="center">
                ...
                <td width="100">项目收入</td>
                <td width="100">项目成本</td>
                <td width="100">相关税费</td>
                <td width="100">应分摊期间费用</td>
                <td width="100">纳税调整额</td>
                <td width="100">项目所得额</td>
                <td width="100">减免所得额</td>
                <td width="100">备注</td>
            </tr>                
            <tr height="25" align="center">
                <td width="100">1</td>            
