...
<head>
	...
	<title>与未实现融资收益相关在当期确认的财务费用审核表</title>
  </head>
   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">与未实现融资收益相关在当期确认的财务费用审核表</strong>
         ...
         <table id="gridlist_table" width="2560" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="16" height="33"  align="right">索引号：3-2-9</td>
            </tr>
            <tr height="33">
                <td colspan="14" width="2240">被审核单位名称：${QYMC}</td>
                <td width="160">金额单位：元</td>
            </tr>
 
            <tr height="33">
                <td rowspan="2" colspan="4" width="640">会计期间或会计截止日：</td>
                <td rowspan="2" colspan="6" width="960">${KJQJ}</td>
                <td width="160">编制人</td>
            ...
            <tr height="25">
                ...
                <td width="160">项目</td>
                <td width="160">具体内容</td>
                <td width="160">起始年度</td>
                <td width="160">未审数</td>
                <td width="160">调整数</td>
                <td width="160">审核数</td>
                <td width="160">累计会计审核数</td>
                <td width="160">本年税收金额</td>
                <td width="160">累计税收金额</td>
                <td width="160">本年调增金额</td>
                <td width="160">累计调增金额</td>
                <td width="160">本年调减金额</td>
                <td width="160">累计调减金额</td>
                <td width="160">备注</td>
            </tr>
            <tr height="25">
                <td width="160">1</td>
       ...
       <div class="row-fluid">
         <div class="span">           
                <div id="gridlist" class="DataGrid" type="DataGrid" userdefine="true">
					...
					<div name="DGHC" type="text" caption="行次" style="display:none"></div>
  			...
  			<form class="form-horizontal" role="form" id="formmap">
				<table align="center" style="border-collapse: collapse" ; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="2570">
