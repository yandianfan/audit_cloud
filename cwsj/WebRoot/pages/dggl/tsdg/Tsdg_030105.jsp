  ...
  <body>
   	<div class="page-content">
		<div class="col-xs-12">
         ...
         <table id="gridlist_table" width="90%" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="6" height="33"  align="right">索引号：3-1-5</td>
            </tr>
            <tr height="33">
                <td colspan="5" width="840">被审核单位名称：${QYMC}</td>
                <td width="120" >金额单位：元</td>
            </tr>
 
            <tr height=33>
                <td rowspan="2">会计期间或会计截止日：</td>
                <td rowspan="2" width="120">${KJQJ}　</td>
                <td width="120">编制人</td>
                <td width="120">${BZR}　</td>
                <td width="120">日期</td>
            ...
            <tr height=25>
                <td width="40">请&nbsp;选&nbsp;择</td>
                <td style="display:none">行次</td>
                <td>资产明细</td>
                <td>账载金额</td>
                <td>税收金额</td>
                <td>纳税调增金额</td>
       ...
       <div class="row-fluid">
         <div class="span">           
                <div id="gridlist" class="DataGrid" type="DataGrid" userdefine="true">
					...
					<div name="DGHC" type="text" caption="行次" style="display:none" css="width:99%" align="center"></div>
