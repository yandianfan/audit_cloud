   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">特殊行业准备金纳税调整明细审核表</strong>
         ...
         <table id="gridlist_table" width="1120" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="7" height="33"  align="right">索引号：3-4-2</td>
            </tr>
            <tr height="33">
            ...
            <tr height="25">
                ...
                <td rowspan=2 colspan="2" width="320"">项目</td>
