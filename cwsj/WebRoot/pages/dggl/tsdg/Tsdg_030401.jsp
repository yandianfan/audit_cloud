   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">企业重组纳税调整审核表</strong>
         ...
         <table id="gridlist_table" width="1200" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="11" height="33"  align="right">索引号：3-4-1</td>
            </tr>
            <tr height="33">
                <td colspan="10" width="1040">被审核单位名称：${QYMC}</td>
            ...
            <tr height="25">
                ...
                <td colspan="3" >一般性税务处理</td>
                <td colspan="3" >特殊性税务处理</td>
                <td rowspan="2" >纳税调整金额</td>
                <td rowspan="2">备注</td>
            </tr>
            <tr height="25">
                <td>账载金额</td>
