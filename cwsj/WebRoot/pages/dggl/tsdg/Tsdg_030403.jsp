   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">政策性搬迁纳税调整审核表</strong>
         ...
         <table id="gridlist_table" width="1120" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="7" height="33"  align="right">索引号：3-4-3</td>
            </tr>
            <tr height="33">
...
<tr height="25">
  ...
  <td colspan="4" width="640">金额</td>
                ...
                <div id="gridlist" class="DataGrid" type="DataGrid" userdefine="true">
					...
					<div name="COL1" colspan="4" type="text" css="width:99%"></div>
                </div>
