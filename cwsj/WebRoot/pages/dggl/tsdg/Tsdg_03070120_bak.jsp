...
<head>
  ...
  <body>
   	<div class="page-content">
		<div class="col-xs-12">
         ...
         <table id="tab1" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="1520">

            <tr height="33">
                <td colspan="10" align="right">索引号：3-7-1-20</td>
            </tr>
            <tr height="33">
            ...
            <tr height="33">
                ...
                <td colspan="4" rowspan="2" width="640">${KJQJ}</td>
                <td width="160">编制人</td>
                <td width="160">${BZR}</td>
                <td width="160">日期</td>
   ...
   <table id="gridlist_1_table" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="1520">  
            <tr height="25">
                <td rowspan="2" width="240">序号</td>
                <td width="160">项目</td>
  ...
  <table id="gridlist_2_table" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="1520">	
            <tr height="25">
                <td width="80">请选择</td>
                <td width="160">序号</td>
                <td width="160">项目</td>
       ...
       <div class="row-fluid">
         <div class="span">   
   				<div id="gridlist_2" class="DataGrid" type="DataGrid" userdefine="true">
					...
					<div name="DGHC" caption="行次" css="width:99%" type="text"></div>
					<div name="DGHMC" caption="项目" css="width:99%" type="text"></div>
					<div name="COL1" type="text" css="width:99%"></div>
					<div name="COL2" type="text" css="width:99%"></div>
					<div name="COL3" type="text" css="width:99%"></div>
					<div name="COL4" type="text" css="width:99%"></div>
       	   ...
       	   <div class="btn-group btn-group-xs">
   			...
   			<form class="form-horizontal" role="form" id="formmap">
				<table  align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000"  width="1520">
