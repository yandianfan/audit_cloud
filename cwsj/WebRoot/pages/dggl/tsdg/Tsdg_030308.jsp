   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">资产损失税前扣除及纳税调整审核表</strong>
         ...
         <table id="gridlist_table" width="1200" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="8" height="33"  align="right">索引号：3-3-8</td>
            </tr>
            <tr height="33">
            ...
            <tr height="25">
                ...
                <td rowspan="2" colspan="3" width="480">项目</td>
            ...
            <tr height="25">
                ...
                <div id="gridlist" class="DataGrid" type="DataGrid" userdefine="true">
					...
					<div name="DGHMC" caption="项目" colspan="3"></div>
