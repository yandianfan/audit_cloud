...
<head>
   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">住房公积金审核表</strong>
 ...
 <tr>
  <td colspan="10" align="right">索引号：3-2-1-6</td>
 </tr>
 
 <tr class=xl7911305 height=16 style='height:12.0pt'>
  <td colspan=9 height=16 class=xl10011305 width=738 style='height:12.0pt;width:555pt'>被审核单位名称：${QYMC}</td>
  <td class=xl8011305>金额单位：元</td>
 </tr>
 <tr class=xl7911305 height=16 style='height:12.0pt'>
  <td colspan=3 rowspan=2 height=32 class=xl8111305 style='height:24.0pt'>会计期间或会计截止日：</td>
  <td colspan=2 rowspan=2 width=100>${KJQJ}　</td>
  <td class=xl8211305 width=91 style='border-top:none;border-left:none;
  width:68pt'>编制人</td>
  <td width=100 style='border-top:none;border-left:none'>${BZR}　</td>
  <td class=xl8111305 style='border-top:none;border-left:none'>日期</td>
  <td width=100 colspan=2>${BZRQ}　</td>
 </tr>
 <tr class=xl7811305 height=16 style='height:12.0pt'>
  <td height=16 class=xl8211305 width=91 style='height:12.0pt;border-top:none;
  border-left:none;width:68pt'>复核人</td>
  <td class=xl8311305 style='border-top:none;border-left:none'>${FHR}　</td>
  <td class=xl8111305 style='border-top:none;border-left:none'>日期</td>
 ...
 <tr height=32 style='height:24.0pt'>
  <td rowspan=2 align="center">行次</td>
  <td align="center">项目</td>
  <td align="center" width=93>未审数</td>
  <td align="center" width=87 style='border-top:none;border-left:none;
  width:65pt'>调整数</td>
  <td align="center" style='border-top:none;border-left:none'>审核数</td>
  <td align="center" width=91 style='border-top:none;border-left:none;
  width:68pt'>税收规定扣除率<span style='mso-spacerun:yes'>&nbsp;</span></td>
  <td align="center" width=82 style='border-top:none;border-left:none;
  width:62pt'>工资薪金总额</td>
  <td align="center" width=84 style='border-top:none;border-left:none;
  width:63pt'>税收金额</td>
  <td align="center" style='border-top:none;border-left:none'>纳税调整金额</td>
  <td align="center" width=86 style='border-top:none;border-left:none;
  width:65pt'>备注</td>
 ...
 <tr height=16 style='height:12.0pt'>
  <td colspan=10 align="center">住房公积金计入成本费用的金额明细</td>
 </tr>
 <tr height=16 style='height:12.0pt'>
  <td align="center">行次</td>
  <td align="center">项目</td>
  <td align="center">管理费用</td>
  <td align="center">销售费用</td>
  <td align="center">主营业务成本</td>
  <td align="center" width=91 >其他业务成本</td>
  <td align="center" width=166 >其他</td>
  <td align="center" width=176 >合计</td>
 </tr>
  </table>  
