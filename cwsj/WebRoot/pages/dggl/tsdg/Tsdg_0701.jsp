   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">预缴所得税审核表</strong>
         ...
         <table id="gridlist_table" width="1120" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="7" height="33"  align="right">索引号：7-1</td>
            </tr>
            <tr height="33">
            ...
            <tr height="25">
                ...
                <td colspan="6" width="960">所得税缴纳记录</td>
            </tr>
            <tr height="25">
                <td colspan="2" width="320">项目</td>
                <td width="160">金额</td>
                <td width="160">入库时间</td>
                <td width="160">缴款书号码</td>
                <td width="160">备注</td>
            </tr>
            <tr height="25">
                <td colspan="2" width="320">1 </td>
                <td width="160">2 </td>
                <td width="160">3 </td>
                <td width="160">4 </td>
                <td width="160">5 </td>
                ...
                <div id="gridlist" class="DataGrid" type="DataGrid" userdefine="true">
					...
					<div name="DGHMC" caption="项目" colspan="2"></div>
