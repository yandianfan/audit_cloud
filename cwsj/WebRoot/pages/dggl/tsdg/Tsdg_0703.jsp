...
<head>
	...
	<title>跨地区经营汇总纳税企业年度分摊企业所得税审核表</title>
  </head>
   	...
   	<div class="page-content">
		<div class="col-xs-12">
		 <div class="row page-header text-center">
            <strong class="sb-title3">跨地区经营汇总纳税企业年度分摊企业所得税审核表</strong>
         ...
         <table id="gridlist_table" width="960" align="center" style="border-collapse: collapse"; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000">  
            <tr height="33">
                <td colspan="6" height="33"  align="right">索引号：7-03</td>
            </tr>
            <tr height="33">
                <td colspan="5" width="800">被审核单位名称：${QYMC}</td>
            ...
            <tr height="25">
                ...
                <td colspan="4" width="640" align="center">项目</td>
                <td width="160" align="center">金额</td>
            </tr>
  			...
  			<form class="form-horizontal" role="form" id="formmap">
				<table align="center" style="border-collapse: collapse" ; border="1" cellspacing="1" cellpadding="1" bordercolor="#000000" width="960">
